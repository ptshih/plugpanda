      ...
      <article>
        <section>
          <div className="text-xs-center">
            ...
            <div><img className="img img--faq" src="/img/sessions.jpg"/></div>
          </div>
        </section>
        ...
        <section>
          <div className="text-xs-center">
            ...
            <div><img className="img img--faq" src="/img/session.jpg"/></div>
          </div>
        </section>
        ...
        <section>
          <div className="text-xs-center">
            ...
            <div><img className="img img--faq" src="/img/dashboard.jpg"/></div>
          </div>
        </section>
        ...
        <section>
          <div className="text-xs-center">
            ...
            <div><img className="img img--faq" src="/img/bmw.jpg"/></div>
          </div>
        </section>
